window.bioMp = function(el, options) {
	...
	function create() {
		...
		var phoneCss = 'position: relative; top: 0px; left: 0px; width: ' + selView.width +
			...
			scale + '); -moz-transform: scale(' + scale + '); -ms-transform: scale(' +
			scale + '); -o-transform: scale(' + scale + '); transform: scale(' + scale +
			');';
		var phoneImageCss =
